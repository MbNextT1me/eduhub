...
public interface FileRepository extends JpaRepository<File, String> {
    @Query("SELECT new ru.gormikle.eduhub.dto.FileDto(f.name, f.category) FROM File f WHERE f.category = :category")
    Optional<FileDto> findAllDtoByCategory(@Param("category") FileCategory category);
